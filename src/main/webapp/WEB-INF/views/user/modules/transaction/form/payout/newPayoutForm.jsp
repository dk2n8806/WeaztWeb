...
<div id="newPayoutBlk" style="display: none">
	<div class="modal-header">
		<h3>New Payout Method</h3>
	</div>
	<spring:url value="/user/create-new-payout" var="newPayoutForm" htmlEscape="true" />
	<div id="response"></div>
	<form id="newPayoutForm" action="${newPayoutForm }" method="POST">
	...
	<div class="modal-footer prefix-clear">
		<button type="submit" class="btn merchantBtn toRight"><strong>Add Card</strong></button>
	</div>
	</form>
</div>
...
$(document).ready(function() {
	...
	$("#newPayoutForm").on("submit", function(event) {
		var $this = $(this);
