				...
				<div class="col">
					<div class="blk">
						<div class="blk-header">
							<h1 class="fnor">Private Listings</h1>
							<p><span id="overviewListing" data-num="${size}" data-status="private" ></span></p>
						</div>	
					</div>
				</div>
			</div>
...
$(document).ready(function() {
	function init() {
		...
		$("#privateListingNav").addClass("active");
		buildProductLink();
		overviewListing();
	}; init(); 
	...
	;function overviewListing() {
		...
		$a.html("You have <strong>" + n + " " + s + " " + x + "</strong>. Private product is only visible to current subscriber.");
	}
