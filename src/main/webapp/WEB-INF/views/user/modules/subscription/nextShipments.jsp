				...
				<div class="col">
					<div class="blk">
						<div class="blk-header">
							<h1 class="fnor">Scheduled Shipments</h1>
							<!-- <p>Here is your scheduled shipments</p> -->
						</div>
					</div>
				</div>
			</div>
			<div class="col-wrapper">
				...
				<div class="col-2">
					...
					<c:set var="scheduledOn">
						<fmt:formatDate value="${template.scheduledOn }"/>
					</c:set>
					<div class="blk-b">
						<div class="blk-header">
							<h3 class="fontCap">
						...
						<div class="blk-footer">
							<p class=""><span class="tip">Estimated delivery day:</span>&nbsp;&nbsp;<strong><span class=""><i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;${scheduledOn }</span></strong></p>
						</div>
					</div>
				</div>
				</c:forEach>
